...
public class ProductCreateDto {
    ...
    public ProductCreateDto(String name, BigDecimal price, String category, UUID shopId) {
        this.name = name;
        this.price = price;
    ...
    // Full constructor.
    public ProductCreateDto(String name, BigDecimal price, String category, UUID shopId, String description, BigDecimal discount, String imageUrl, boolean isFeatured, boolean active) {
        this.name = name;
        this.price = price;
        this.category = category;
        this.shopId = shopId;
    ...
    public Product toEntity(Shop shop) {
        ...
        Product product = new Product(shop, this.name, this.price, this.category);
